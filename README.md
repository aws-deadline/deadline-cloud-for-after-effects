...
1. This submitter requires the ability to write files and send communication over the network in order to function properly.
   ...
   Additionally, to disable warnings every time you submit a job with the submitter, deselect the following: `Select Edit > Preferences > Scripting & Expressions > deselect Warn User When Executing Files`
